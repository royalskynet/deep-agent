...
- Task scope is fixed; do not renegotiate it. Doubts go into the report under NOT DONE.
...
Report in Traditional Chinese. No action narration, no restating tool output, no plans up front — one sentence of conclusion per stage.